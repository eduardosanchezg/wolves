...
public interface Wolf {
	public abstract int[] moveAll(List<int[]> wolvesSight, List<int[]> preysSight, int[][] relativeGrid);
	...
	public abstract int moveLim(List<int[]> wolvesSight, List<int[]> preysSight, int[][] relativeGrid);
